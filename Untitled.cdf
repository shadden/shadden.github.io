...
NotebookDataLength[     33317,        796]
NotebookOptionsPosition[     33746,        787]
NotebookOutlinePosition[     34246,        808]
CellTagsIndexPosition[     34203,        805]
WindowFrame->Normal*)
...
CellContext`i])^Rational[1, 2]] ((1 + $CellContext`e[$CellContext`i])/(
      ...
      And[$CellContext`x[2, 1][$CellContext`t] - $CellContext`x[
       ...
       0, $CellContext`x[2, 2][$CellContext`t] - $CellContext`x[
        1, 2][$CellContext`t] > 0], 
      Sow[$CellContext`t]]; Null)]], "Output"]
}, {2}]]
},
WindowSize->{1562, 1101},
WindowMargins->{{Automatic, 107}, {8, Automatic}},
Visible->True,
...
Notebook[{
Cell[CellGroupData[{
Cell[1486, 35, 17518, 442, 1144, "Input"],
Cell[19007, 479, 14726, 305, 550, "Output"]
}, {2}]]
}
]
*)
...
(* NotebookSignature cxT2vG8TiZhPPB1#kiVpu#OM *)
